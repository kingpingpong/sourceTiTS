package classes.UIComponents.MiniMap
{
	...
	public class MiniMap extends Sprite
	{
		...
		public static const ICON_MYSTERY = 9;
		...
		public static const ICON_NAMES:Array = new Array("Map_Ship", "Map_Quest", "Map_Objective", "Map_NPC", "Map_Medical", "Map_Down", "Map_Up", "Map_Commerce", "Map_Bar", "Map_Mystery");
		...
		private function mapRoom(room:RoomClass, xPos:int, yPos:int, roomsObj:*, animate:Boolean = false, completeRooms:Array = null):void
		{
			...
			else if(room.hasFlag(GLOBAL.UNVISITED))  tarSprite.setIcon(ICON_MYSTERY);
