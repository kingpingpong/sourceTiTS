...
function thraggenAreABunchOfGreenLesboSlutsGardefordToldMeSo():void
{
	...
	output("\n\nAs she speaks, her hands strip you of your [pc.gear]. Her free hand grips the [pc.skinFurScales] of your shoulder, while the arm that's under you concedes to groping at one cheek of your [pc.butt]. You join her after you’re free of obstructions, ripping away the tattered remains of her shirt and corset. Her breasts fall fully free when you’re done, still glistening with the sweat of your fight.");
...
function victoryKaskaDicksex():void
{
	...
	output("\n\nAs you pull back to line up your second stroke, you ponder her words, wondering if those are the kinds of things she likes girls to say to her. Kaska bubbles, <i>\"Fuck me!\"</i> again when you thrust home. There's no need to take it slow with how wet she is. Juices dribble down her thighs with every piston-like pump into her thighs, and her voice is all too happy to release high-pitched squeals of intermingled ecstasy and excitement. You let her have it and commence drilling her gushing honeypot in earnest, watching her plush ass and luscious tits jiggle and quake from the force of the pounding.");
...
function makeKaskaSuchYerCoochLikeABaws():void
{
	...
	else
	{
		...
		output("\n\n<i>\"You're gonna please " + (pc.vaginas.length > 1 ? "those pussies" : "that pussy") + ",\"</i> you command, <i>\"and if you do a good enough job, I might let you tug on your dick while you do it.\"</i>");
	}
	//Merge
