...
import classes.RoomClass;
	...
	rooms[""].addFlag(GLOBAL.UNDISCOVERED);
	rooms[""].addFlag(GLOBAL.UNVISITED);
	*/
...
function initializeRooms():void 
{
	...
	//99. Ship Interior
	rooms["SHIP INTERIOR"] = new RoomClass(this, "SHIP INTERIOR");
	...
	//100. Hotel Room
	rooms["HOTEL ROOM"] = new RoomClass(this, "HOTEL ROOM");
	...
	rooms["ANON'S BOARD HALL"] = new RoomClass(this, "ANON'S BOARD HALL");
	...
	rooms["ANON'S BAR AND BOARD"] = new RoomClass(this, "ANON'S BAR AND BOARD");
	...
	rooms["MERCHANT'S THOROUGHFARE"] = new RoomClass(this, "MERCHANT'S THOROUGHFARE");
	...
	rooms["LIFT: MERCHANT DECK"] = new RoomClass(this, "LIFT: MERCHANT DECK");
	...
	rooms["TAVROS HANGAR"] = new RoomClass(this, "TAVROS HANGAR");
	...
	rooms["TAVROS LIFT"] = new RoomClass(this, "TAVROS LIFT");
	...
	rooms["DARK CHRYSALIS"] = new RoomClass(this, "DARK CHRYSALIS");
	...
	rooms["FUR EFFECT"] = new RoomClass(this, "FUR EFFECT");
	...
	rooms["BETHS BROADS"] = new RoomClass(this, "BETHS BROADS");
	...
	//109 "BETHS BROADS" Beth's Busty Broads
	rooms["MI AMOUR"] = new RoomClass(this, "MI AMOUR");
	...
	rooms["110"] = new RoomClass(this, "110");
	...
	//0. Ship Hanger
	rooms["SHIP HANGAR"] = new RoomClass(this, "SHIP HANGAR");
	...
	//2 - Flahne's Office
	rooms["CUSTOMS OFFICE"] = new RoomClass(this, "CUSTOMS OFFICE");
	...
	rooms["ESBETH'S NORTH PATH"] = new RoomClass(this, "ESBETH'S NORTH PATH");
	...
	rooms["NORTHWEST ESBETH"] = new RoomClass(this, "NORTHWEST ESBETH");
	...
	rooms["WEST ESBETH 1"] = new RoomClass(this, "WEST ESBETH 1");
	...
	rooms["WEST ESBETH 2"] = new RoomClass(this, "WEST ESBETH 2");
	...
	rooms["SOUTHWEST ESBETH"] = new RoomClass(this, "SOUTHWEST ESBETH");
	...
	rooms["SOUTH ESBETH 2"] = new RoomClass(this, "SOUTH ESBETH 2");
	...
	rooms["SOUTH ESBETH 3"] = new RoomClass(this, "SOUTH ESBETH 3");
	...
	rooms["SOUTHEAST ESBETH"] = new RoomClass(this, "SOUTHEAST ESBETH");
	...
	rooms["EAST ESBETH"] = new RoomClass(this, "EAST ESBETH");
	...
	rooms["EAST ESBETH ENTRANCE"] = new RoomClass(this, "EAST ESBETH ENTRANCE");
	...
	rooms["NORTHEAST ESBETH"] = new RoomClass(this, "NORTHEAST ESBETH");
	...
	rooms["NORTH ESBETH 1"] = new RoomClass(this, "NORTH ESBETH 1");
	...
	rooms["NORTH ESBETH 2"] = new RoomClass(this, "NORTH ESBETH 2");
	...
	rooms["BURT'S MAIN HALL"] = new RoomClass(this, "BURT'S MAIN HALL");
	...
	rooms["BURT'S BACK END"] = new RoomClass(this, "BURT'S BACK END");
	...
	rooms["EAST ESBETH EXIT"] = new RoomClass(this, "EAST ESBETH EXIT");
	...
	rooms["JUNGLE EDGE"] = new RoomClass(this, "JUNGLE EDGE");
	...
	rooms["JUNGLE EDGE"].addFlag(GLOBAL.UNVISITED);

	//21. A Bend in the Fern-Shrouded Path
	rooms["FERNGROWTH PATH 1"] = new RoomClass(this, "FERNGROWTH PATH 1");
	...
	rooms["FERNGROWTH PATH 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNGROWTH PATH 1"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNGROWTH PATH 1"].runOnEnter = jungleEncounterChances;

	//22. A Fern-Shrouded Path
	rooms["FERNGROWTH PATH 2"] = new RoomClass(this, "FERNGROWTH PATH 2");
	...
	rooms["FERNGROWTH PATH 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNGROWTH PATH 2"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNGROWTH PATH 2"].runOnEnter = jungleEncounterChances;

	//23. Ferngrowth Bend
	rooms["FERNGROWTH BEND 1"] = new RoomClass(this, "FERNGROWTH BEND 1");
	...
	rooms["FERNGROWTH BEND 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNGROWTH BEND 1"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNGROWTH BEND 1"].runOnEnter = jungleEncounterChances;

	//24. A Fern-Shrouded Path
	rooms["FERNGROWTH PATH 3"] = new RoomClass(this, "FERNGROWTH PATH 3");
	...
	rooms["FERNGROWTH PATH 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNGROWTH PATH 3"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNGROWTH PATH 3"].runOnEnter = jungleEncounterChances;

	//25. A Fern-Shrouded Path
	rooms["FERNGROWTH PATH 4"] = new RoomClass(this, "FERNGROWTH PATH 4");
	...
	rooms["FERNGROWTH PATH 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNGROWTH PATH 4"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNGROWTH PATH 4"].runOnEnter = jungleEncounterChances;

	//26. The Intersection of Ferns and Lichens
	rooms["FERNS AT LICHENS 1"] = new RoomClass(this, "FERNS AT LICHENS 1");
	...
	rooms["FERNS AT LICHENS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FERNS AT LICHENS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["FERNS AT LICHENS 1"].runOnEnter = jungleEncounterChances;

	//27. A Bend in the Lichens
	rooms["LICHENS BEND 1"] = new RoomClass(this, "LICHENS BEND 1");
	...
	rooms["LICHENS BEND 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS BEND 1"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS BEND 1"].runOnEnter = jungleEncounterChances;

	//28. The Lichen-Covered Jungle
	rooms["LICHENS 1"] = new RoomClass(this, "LICHENS 1");
	...
	rooms["LICHENS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS 1"].runOnEnter = jungleEncounterChances;

	//29. The Intersection of Lichens and Giant Ironwoods
	rooms["LICHENS AT IRONWOODS 1"] = new RoomClass(this, "LICHENS AT IRONWOODS 1");
	...
	rooms["LICHENS AT IRONWOODS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS AT IRONWOODS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS AT IRONWOODS 1"].runOnEnter = jungleEncounterChances;

	//30.Between Lichens and Ironwoods
	rooms["LICHENS AND IRONWOODS 1"] = new RoomClass(this, "LICHENS AND IRONWOODS 1");
	...
	rooms["LICHENS AND IRONWOODS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS AND IRONWOODS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS AND IRONWOODS 1"].runOnEnter = jungleEncounterChances;

	//31. Between Lichens and Ironwoods
	rooms["LICHENS AND IRONWOODS 2"] = new RoomClass(this, "LICHENS AND IRONWOODS 2");
	...
	rooms["LICHENS AND IRONWOODS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS AND IRONWOODS 2"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS AND IRONWOODS 2"].runOnEnter = jungleEncounterChances;

	//32. Between Lichens and Ironwoods
	rooms["LICHENS AND IRONWOODS 3"] = new RoomClass(this, "LICHENS AND IRONWOODS 3");
	...
	rooms["LICHENS AND IRONWOODS 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS AND IRONWOODS 3"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS AND IRONWOODS 3"].runOnEnter = jungleEncounterChances;

	//33. An Intersection of Lichens and Ironwoods
	rooms["LICHENS AT IRONWOODS 2"] = new RoomClass(this, "LICHENS AT IRONWOODS 2");
	...
	rooms["LICHENS AT IRONWOODS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS AT IRONWOODS 2"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS AT IRONWOODS 2"].runOnEnter = jungleEncounterChances;

	//34. The Lichen-Covered Jungle
	rooms["LICHENS 2"] = new RoomClass(this, "LICHENS 2");
	...
	rooms["LICHENS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS 2"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS 2"].runOnEnter = jungleEncounterChances;

	//35. A Bend in the Lichens
	rooms["LICHENS BEND 2"] = new RoomClass(this, "LICHENS BEND 2");
	...
	rooms["LICHENS BEND 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS BEND 2"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS BEND 2"].runOnEnter = jungleEncounterChances;

	//36. The Lichen-Covered Jungle
	rooms["LICHENS 3"] = new RoomClass(this, "LICHENS 3");
	...
	rooms["LICHENS 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS 3"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS 3"].runOnEnter = jungleEncounterChances;

	//37. The Lichen-Covered Jungle
	rooms["LICHENS 4"] = new RoomClass(this, "LICHENS 4");
	...
	rooms["LICHENS 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["LICHENS 4"].addFlag(GLOBAL.UNVISITED);
	rooms["LICHENS 4"].runOnEnter = jungleEncounterChances;

	//38. The Ironwoods
	rooms["IRONWOODS 1"] = new RoomClass(this, "IRONWOODS 1");
	...
	rooms["IRONWOODS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRONWOODS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["IRONWOODS 1"].runOnEnter = jungleEncounterChances;

	//39. Bending Through the Ironwoods
	rooms["IRONWOODS BEND 1"] = new RoomClass(this, "IRONWOODS BEND 1");
	...
	rooms["IRONWOODS BEND 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRONWOODS BEND 1"].addFlag(GLOBAL.UNVISITED);
	rooms["IRONWOODS BEND 1"].runOnEnter = jungleEncounterChances;

	//40. The Ironwoods
	rooms["IRONWOODS 2"] = new RoomClass(this, "IRONWOODS 2");
	...
	rooms["IRONWOODS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRONWOODS 2"].addFlag(GLOBAL.UNVISITED);
	rooms["IRONWOODS 2"].runOnEnter = jungleEncounterChances;

	//41. The Babbling Brook
	rooms["BABBLING BROOK 1"] = new RoomClass(this, "BABBLING BROOK 1");
	...
	rooms["BABBLING BROOK 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["BABBLING BROOK 1"].addFlag(GLOBAL.UNVISITED);
	rooms["BABBLING BROOK 1"].runOnEnter = jungleEncounterChances;

	//42. The Ironwoods
	rooms["IRONWOODS 3"] = new RoomClass(this, "IRONWOODS 3");
	...
	rooms["IRONWOODS 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRONWOODS 3"].addFlag(GLOBAL.UNVISITED);
	rooms["IRONWOODS 3"].runOnEnter = jungleEncounterChances;

	//43. A Bend in the Ironwoods
	rooms["IRONWOODS BEND 2"] = new RoomClass(this, "IRONWOODS BEND 2");
	...
	rooms["IRONWOODS BEND 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRONWOODS BEND 2"].addFlag(GLOBAL.UNVISITED);
	rooms["IRONWOODS BEND 2"].runOnEnter = jungleEncounterChances;

	//44. The Dense Orange
	//10m travel time?
	rooms["DENSE ORANGE 1"] = new RoomClass(this, "DENSE ORANGE 1");
	...
	rooms["DENSE ORANGE 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DENSE ORANGE 1"].addFlag(GLOBAL.UNVISITED);
	rooms["DENSE ORANGE 1"].runOnEnter = jungleMiddleEncounters;

	//45. The Dense Orange
	rooms["DENSE ORANGE 2"] = new RoomClass(this, "DENSE ORANGE 2");
	...
	rooms["DENSE ORANGE 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DENSE ORANGE 2"].addFlag(GLOBAL.UNVISITED);
	rooms["DENSE ORANGE 2"].runOnEnter = jungleMiddleEncounters;

	//46. The Dense Orange
	rooms["DENSE ORANGE 3"] = new RoomClass(this, "DENSE ORANGE 3");
	...
	rooms["DENSE ORANGE 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DENSE ORANGE 3"].addFlag(GLOBAL.UNVISITED);
	rooms["DENSE ORANGE 3"].runOnEnter = jungleMiddleEncounters;

	//47. The Dense Orange
	rooms["DENSE ORANGE 4"] = new RoomClass(this, "DENSE ORANGE 4");
	...
	rooms["DENSE ORANGE 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DENSE ORANGE 4"].addFlag(GLOBAL.UNVISITED);
	rooms["DENSE ORANGE 4"].runOnEnter = jungleMiddleEncounters;

	//48. An Orange Intersection
	rooms["ORANGE INTERSECTION 1"] = new RoomClass(this, "ORANGE INTERSECTION 1");
	...
	rooms["ORANGE INTERSECTION 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["ORANGE INTERSECTION 1"].addFlag(GLOBAL.UNVISITED);
	rooms["ORANGE INTERSECTION 1"].runOnEnter = jungleMiddleEncounters;

	//49. The Dense Orange
	rooms["DENSE ORANGE 5"] = new RoomClass(this, "DENSE ORANGE 5");
	...
	rooms["DENSE ORANGE 5"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DENSE ORANGE 5"].addFlag(GLOBAL.UNVISITED);
	rooms["DENSE ORANGE 5"].runOnEnter = jungleMiddleEncounters;

	//50. Dark Orange Corner
	rooms["DARK ORANGE CORNER 1"] = new RoomClass(this, "DARK ORANGE CORNER 1");
	...
	rooms["DARK ORANGE CORNER 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DARK ORANGE CORNER 1"].addFlag(GLOBAL.UNVISITED);
	rooms["DARK ORANGE CORNER 1"].runOnEnter = jungleMiddleEncounters;

	//51. Deep Forest
	rooms["DEEP FOREST 1"] = new RoomClass(this, "DEEP FOREST 1");
	...
	rooms["DEEP FOREST 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP FOREST 1"].addFlag(GLOBAL.UNVISITED);
	rooms["DEEP FOREST 1"].runOnEnter = jungleMiddleEncounters;

	//52. Deep Intersection
	rooms["DEEP INTERSECTION 1"] = new RoomClass(this, "DEEP INTERSECTION 1");
	...
	rooms["DEEP INTERSECTION 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP INTERSECTION 1"].addFlag(GLOBAL.UNVISITED);
	rooms["DEEP INTERSECTION 1"].runOnEnter = jungleMiddleEncounters;

	//53. Deep Forest
	rooms["DEEP FOREST 2"] = new RoomClass(this, "DEEP FOREST 2");
	...
	rooms["DEEP FOREST 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP FOREST 2"].addFlag(GLOBAL.UNVISITED);
	rooms["DEEP FOREST 2"].runOnEnter = jungleMiddleEncounters;

	//54. Corner of Iron and Dark
	rooms["IRON AND DARK CORNER 1"] = new RoomClass(this, "IRON AND DARK CORNER 1");
	...
	rooms["IRON AND DARK CORNER 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["IRON AND DARK CORNER 1"].addFlag(GLOBAL.UNVISITED);
	rooms["IRON AND DARK CORNER 1"].runOnEnter = jungleMiddleEncounters;

	//55. Narrow Path
	rooms["NARROW PATH 1"] = new RoomClass(this, "NARROW PATH 1");
	...
	rooms["NARROW PATH 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW PATH 1"].addFlag(GLOBAL.UNVISITED);
	rooms["NARROW PATH 1"].runOnEnter = jungleMiddleEncounters;

	//56. Narrow Bend
	rooms["NARROW BEND 1"] = new RoomClass(this, "NARROW BEND 1");
	...
	rooms["NARROW BEND 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW BEND 1"].addFlag(GLOBAL.UNVISITED);
	rooms["NARROW BEND 1"].runOnEnter = jungleMiddleEncounters;

	//57. Narrow Jungle Path
	//DEEP JURGLE
	rooms["NARROW PATH 2"] = new RoomClass(this, "NARROW PATH 2");
	...
	rooms["NARROW PATH 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW PATH 2"].addFlag(GLOBAL.UNVISITED);
	rooms["NARROW PATH 2"].runOnEnter = jungleMiddleEncounters;

	//58. Narrow Jungle Path
	rooms["NARROW PATH 3"] = new RoomClass(this, "NARROW PATH 3");
	...
	rooms["NARROW PATH 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW PATH 3"].addFlag(GLOBAL.UNVISITED);
	rooms["NARROW PATH 3"].runOnEnter = jungleMiddleEncounters;

	//59. Dead End
	rooms["METAL POD 1"] = new RoomClass(this, "METAL POD 1");
	...
	rooms["METAL POD 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["METAL POD 1"].addFlag(GLOBAL.UNVISITED);
	rooms["METAL POD 1"].runOnEnter = approachRivalOnMhenga;

	//60. Deep\nJungle
	rooms["DEEP JUNGLE 1"] = new RoomClass(this, "DEEP JUNGLE 1");
	...
	rooms["DEEP JUNGLE 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP JUNGLE 1"].addFlag(GLOBAL.UNVISITED);
	rooms["DEEP JUNGLE 1"].runOnEnter = jungleDeepEncounters;

	//61. Deep\nJungle
	rooms["DEEP JUNGLE 2"] = new RoomClass(this, "DEEP JUNGLE 2");
	...
	rooms["DEEP JUNGLE 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP JUNGLE 2"].addFlag(GLOBAL.UNVISITED);
	rooms["DEEP JUNGLE 2"].runOnEnter = jungleDeepEncounters;

	//62. Forked\nJungle
	rooms["FORKED DEEP JUNGLE 1"] = new RoomClass(this, "FORKED DEEP JUNGLE 1");
	...
	rooms["FORKED DEEP JUNGLE 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["FORKED DEEP JUNGLE 1"].addFlag(GLOBAL.UNVISITED);
	rooms["FORKED DEEP JUNGLE 1"].runOnEnter = jungleDeepEncounters;

	//63. Vined Jungle
	rooms["VINED JUNGLE 1"] = new RoomClass(this, "VINED JUNGLE 1");
	...
	rooms["VINED JUNGLE 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 1"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 1"].runOnEnter = jungleDeepEncounters;

	//64. Vined Jungle/Corner
	rooms["VINED JUNGLE 2"] = new RoomClass(this, "VINED JUNGLE 2");
	...
	rooms["VINED JUNGLE 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 2"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 2"].runOnEnter = jungleDeepEncounters;

	//65. Vined\nJungle
	rooms["VINED JUNGLE 3"] = new RoomClass(this, "VINED JUNGLE 3");
	...
	rooms["VINED JUNGLE 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 3"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 3"].runOnEnter = jungleDeepEncounters;

	//66. Overgrown\nRock
	rooms["OVERGROWN ROCK 1"] = new RoomClass(this, "OVERGROWN ROCK 1");
	...
	rooms["OVERGROWN ROCK 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 1"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 1"].runOnEnter = jungleDeepEncounters;

	//67. Overgrown\nRock
	rooms["OVERGROWN ROCK 2"] = new RoomClass(this, "OVERGROWN ROCK 2");
	...
	rooms["OVERGROWN ROCK 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 2"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 2"].runOnEnter = jungleDeepEncounters;

	//68. Overgrown\nRock
	rooms["OVERGROWN ROCK 3"] = new RoomClass(this, "OVERGROWN ROCK 3");
	...
	rooms["OVERGROWN ROCK 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 3"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 3"].runOnEnter = jungleDeepEncounters;

	//69. Vined\nJungle
	rooms["VINED JUNGLE 4"] = new RoomClass(this, "VINED JUNGLE 4");
	...
	rooms["VINED JUNGLE 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 4"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 4"].runOnEnter = jungleDeepEncounters;

	//70. Vined\nJungle
	rooms["VINED JUNGLE 5"] = new RoomClass(this, "VINED JUNGLE 5");
	...
	rooms["VINED JUNGLE 5"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 5"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 5"].runOnEnter = jungleDeepEncounters;

	//71. Vined\nJungle
	rooms["VINED JUNGLE 6"] = new RoomClass(this, "VINED JUNGLE 6");
	...
	rooms["VINED JUNGLE 6"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VINED JUNGLE 6"].addFlag(GLOBAL.UNVISITED);
	rooms["VINED JUNGLE 6"].runOnEnter = jungleDeepEncounters;

	//MORE ROOM CODING!
	//72. Overgrown\nRock
	rooms["OVERGROWN ROCK 4"] = new RoomClass(this, "OVERGROWN ROCK 4");
	...
	rooms["OVERGROWN ROCK 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 4"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 4"].runOnEnter = jungleDeepEncounters;

	//73. Overgrown\nRock
	rooms["OVERGROWN ROCK 5"] = new RoomClass(this, "OVERGROWN ROCK 5");
	...
	rooms["OVERGROWN ROCK 5"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 5"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 5"].runOnEnter = jungleDeepEncounters;

	//74. Overgrown\nRock
	rooms["OVERGROWN ROCK 6"] = new RoomClass(this, "OVERGROWN ROCK 6");
	...
	rooms["OVERGROWN ROCK 6"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 6"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 6"].runOnEnter = findOxoniumOnMhenga;

	//75. Overgrown\nRock
	rooms["OVERGROWN ROCK 7"] = new RoomClass(this, "OVERGROWN ROCK 7");
	...
	rooms["OVERGROWN ROCK 7"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 7"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 7"].runOnEnter = jungleDeepEncounters;

	//76. Overgrown\nRock
	rooms["OVERGROWN ROCK 8"] = new RoomClass(this, "OVERGROWN ROCK 8");
	...
	rooms["OVERGROWN ROCK 8"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 8"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 8"].runOnEnter = jungleDeepEncounters;

	//77. Overgrown\nRock
	rooms["OVERGROWN ROCK 9"] = new RoomClass(this, "OVERGROWN ROCK 9");
	...
	rooms["OVERGROWN ROCK 9"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 9"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 9"].runOnEnter = jungleDeepEncounters;

	//78. Overgrown\nRock
	rooms["OVERGROWN ROCK 10"] = new RoomClass(this, "OVERGROWN ROCK 10");
	...
	rooms["OVERGROWN ROCK 10"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 10"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 10"].runOnEnter = jungleDeepEncounters;

	//79. Overgrown\nRock
	rooms["OVERGROWN ROCK 11"] = new RoomClass(this, "OVERGROWN ROCK 11");
	...
	rooms["OVERGROWN ROCK 11"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 11"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 11"].runOnEnter = jungleDeepEncounters;

	//80. Overgrown\nRock
	rooms["OVERGROWN ROCK 12"] = new RoomClass(this, "OVERGROWN ROCK 12");
	...
	rooms["OVERGROWN ROCK 12"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["OVERGROWN ROCK 12"].addFlag(GLOBAL.UNVISITED);
	rooms["OVERGROWN ROCK 12"].runOnEnter = jungleDeepEncounters;

	//81. Giant\nLeaves
	rooms["GIANT LEAVES 1"] = new RoomClass(this, "GIANT LEAVES 1");
	...
	rooms["GIANT LEAVES 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["GIANT LEAVES 1"].addFlag(GLOBAL.UNVISITED);
	rooms["GIANT LEAVES 1"].runOnEnter = jungleDeepEncounters;

	//82. Giant\nLeaves
	rooms["GIANT LEAVES 2"] = new RoomClass(this, "GIANT LEAVES 2");
	...
	rooms["GIANT LEAVES 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["GIANT LEAVES 2"].addFlag(GLOBAL.UNVISITED);
	rooms["GIANT LEAVES 2"].runOnEnter = jungleDeepEncounters;

	//83. Giant\nLeaves
	rooms["GIANT LEAVES 3"] = new RoomClass(this, "GIANT LEAVES 3");
	...
	rooms["GIANT LEAVES 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["GIANT LEAVES 3"].addFlag(GLOBAL.UNVISITED);
	rooms["GIANT LEAVES 3"].runOnEnter = carlsEncounterStart;


	//84. Purple\nFlowers
	rooms["PURPLE FLOWERS 1"] = new RoomClass(this, "PURPLE FLOWERS 1");
	...
	rooms["PURPLE FLOWERS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["PURPLE FLOWERS 1"].addFlag(GLOBAL.UNVISITED);
	rooms["PURPLE FLOWERS 1"].runOnEnter = jungleDeepEncounters;

	//85. Purple\nFlowers
	rooms["PURPLE FLOWERS 2"] = new RoomClass(this, "PURPLE FLOWERS 2");
	...
	rooms["PURPLE FLOWERS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["PURPLE FLOWERS 2"].addFlag(GLOBAL.UNVISITED);
	rooms["PURPLE FLOWERS 2"].runOnEnter = jungleDeepEncounters;

	//86. Purple\nFlowers
	rooms["PURPLE FLOWERS 3"] = new RoomClass(this, "PURPLE FLOWERS 3");
	...
	rooms["PURPLE FLOWERS 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["PURPLE FLOWERS 3"].addFlag(GLOBAL.UNVISITED);
	rooms["PURPLE FLOWERS 3"].runOnEnter = jungleDeepEncounters;

	//87. Purple\nFlowers
	rooms["PURPLE FLOWERS 4"] = new RoomClass(this, "PURPLE FLOWERS 4");
	...
	rooms["PURPLE FLOWERS 4"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["PURPLE FLOWERS 4"].addFlag(GLOBAL.UNVISITED);
	rooms["PURPLE FLOWERS 4"].runOnEnter = jungleEncounterChances;
	
	//88. Scrapyard Maintenance - see scrapyard.as for more info!
	rooms["SCRAPYARD MAINTENANCE"] = new RoomClass(this, "SCRAPYARD MAINTENANCE");
	...
	rooms["PENNY'S OFFICE"] = new RoomClass(this, "PENNY'S OFFICE");
	...
	rooms["KELLY'S OFFICE"] = new RoomClass(this, "KELLY'S OFFICE");
	...
	//91. Julian's Office
	rooms["JULIAN'S OFFICE"] = new RoomClass(this, "JULIAN'S OFFICE");
	...
	//92. Crazy Carls
	rooms["CRAZY CARLS"] = new RoomClass(this, "CRAZY CARLS");
	...
	//93. Medical Office
	rooms["ESBETH MEDICAL OFFICE"] = new RoomClass(this, "ESBETH MEDICAL OFFICE");
	...
	*/
	...
	rooms["A TURNING POINT"] = new RoomClass(this, "A TURNING POINT");
	...
	rooms["A TURNING POINT"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["A TURNING POINT"].addFlag(GLOBAL.UNVISITED);

	rooms["VALLEY DESCENT 1"] = new RoomClass(this, "VALLEY DESCENT 1");
	...
	rooms["VALLEY DESCENT 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VALLEY DESCENT 1"].addFlag(GLOBAL.UNVISITED);

	rooms["VALLEY DESCENT 2"] = new RoomClass(this, "VALLEY DESCENT 2");
	...
	rooms["VALLEY DESCENT 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VALLEY DESCENT 2"].addFlag(GLOBAL.UNVISITED);

	rooms["VALLEY FLOOR"] = new RoomClass(this, "VALLEY FLOOR");
	...
	rooms["VALLEY FLOOR"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["VALLEY FLOOR"].addFlag(GLOBAL.UNVISITED);

	rooms["MISTY VALLEY 1"] = new RoomClass(this, "MISTY VALLEY 1");
	...
	rooms["MISTY VALLEY 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["MISTY VALLEY 1"].addFlag(GLOBAL.UNVISITED);

	rooms["MISTY VALLEY 2"] = new RoomClass(this, "MISTY VALLEY 2");
	...
	rooms["MISTY VALLEY 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["MISTY VALLEY 2"].addFlag(GLOBAL.UNVISITED);

	rooms["MISTY VALLEY 3"] = new RoomClass(this, "MISTY VALLEY 3");
	...
	rooms["MISTY VALLEY 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["MISTY VALLEY 3"].addFlag(GLOBAL.UNVISITED);

	rooms["THICK MIST 1"] = new RoomClass(this, "THICK MIST 1");
	...
	rooms["THICK MIST 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["THICK MIST 1"].addFlag(GLOBAL.UNVISITED);

	rooms["DEEP MIST 2"] = new RoomClass(this, "DEEP MIST 2");
	...
	rooms["DEEP MIST 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP MIST 2"].addFlag(GLOBAL.UNVISITED);

	rooms["DEEP MIST 1"] = new RoomClass(this, "DEEP MIST 1");
	...
	rooms["DEEP MIST 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["DEEP MIST 1"].addFlag(GLOBAL.UNVISITED);

	rooms["THICK MIST 2"] = new RoomClass(this, "THICK MIST 2");
	...
	rooms["THICK MIST 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["THICK MIST 2"].addFlag(GLOBAL.UNVISITED);

	rooms["NARROW GORGE 1"] = new RoomClass(this, "NARROW GORGE 1");
	...
	rooms["NARROW GORGE 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW GORGE 1"].addFlag(GLOBAL.UNVISITED);

	rooms["NARROW GORGE 2"] = new RoomClass(this, "NARROW GORGE 2");
	...
	rooms["NARROW GORGE 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW GORGE 2"].addFlag(GLOBAL.UNVISITED);

	rooms["NARROW GORGE 3"] = new RoomClass(this, "NARROW GORGE 3");
	...
	rooms["NARROW GORGE 3"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["NARROW GORGE 3"].addFlag(GLOBAL.UNVISITED);

	rooms["UTHRA BIRCH"] = new RoomClass(this, "UTHRA BIRCH");
	...
	rooms["UTHRA BIRCH"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["UTHRA BIRCH"].addFlag(GLOBAL.UNVISITED);

	rooms["BLADED FERNS 1"] = new RoomClass(this, "BLADED FERNS 1");
	...
	rooms["BLADED FERNS 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["BLADED FERNS 1"].addFlag(GLOBAL.UNVISITED);

	rooms["BLADED FERNS 2"] = new RoomClass(this, "BLADED FERNS 2");
	...
	rooms["BLADED FERNS 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["BLADED FERNS 2"].addFlag(GLOBAL.UNVISITED);

	rooms["CLOUD FOREST 1"] = new RoomClass(this, "CLOUD FOREST 1");
	...
	rooms["CLOUD FOREST 1"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["CLOUD FOREST 1"].addFlag(GLOBAL.UNVISITED);

	rooms["CLOUD FOREST 2"] = new RoomClass(this, "CLOUD FOREST 2");
	...
	rooms["CLOUD FOREST 2"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["CLOUD FOREST 2"].addFlag(GLOBAL.UNVISITED);

	rooms["CAMP EDGE"] = new RoomClass(this, "CAMP EDGE");
	...
	rooms["CAMP EDGE"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["CAMP EDGE"].addFlag(GLOBAL.UNVISITED);

	rooms["ABANDONED CAMP"] = new RoomClass(this, "ABANDONED CAMP");
	...
	rooms["ABANDONED CAMP"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["ABANDONED CAMP"].addFlag(GLOBAL.UNVISITED);

	// Vanae map additions OVER!

	//#1 Ship Hangar
	rooms["201"] = new RoomClass(this, "201");
	...
	//#2 Eastern Hangar
	rooms["202"] = new RoomClass(this, "202");
	...
	//#3 UPPER STAIRWELL
	rooms["203"] = new RoomClass(this, "203");
	...
	//#4 LOWER STAIRWELL
	rooms["204"] = new RoomClass(this, "204");
	...
	//#5 SHIP CORRIDOR
	rooms["205"] = new RoomClass(this, "205");
	...
	//#6 GLOWING CORRIDOR
	rooms["206"] = new RoomClass(this, "206");
	...
	//#7 NOVAHOME
	rooms["207"] = new RoomClass(this, "207");
	rooms["207"].roomName = "\nNOVAHOME";
	...
	//#8 NOVAHOME
	rooms["208"] = new RoomClass(this, "208");
	rooms["208"].roomName = "\nNOVAHOME";
	...
	//#9 EAST NOVAHOME
	rooms["209"] = new RoomClass(this, "209");
	...
	//#10 NOVAHOME
	rooms["210"] = new RoomClass(this, "210");
	rooms["210"].roomName = "\nNOVAHOME";
	...
	//#11 NOVAHOME
	rooms["211"] = new RoomClass(this, "211");
	rooms["211"].roomName = "\nNOVAHOME";
	...
	//#12 NOVAHOME
	rooms["212"] = new RoomClass(this, "212");
	rooms["212"].roomName = "\nNOVAHOME";
	...
	//#13 NOVAHOME
	rooms["213"] = new RoomClass(this, "213");
	rooms["213"].roomName = "\nNOVAHOME";
	...
	//#14 WEST NOVAHOME
	rooms["214"] = new RoomClass(this, "214");
	...
	rooms["215"] = new RoomClass(this, "215");
	...
	rooms["215"].addFlag(GLOBAL.UNVISITED);
	
	//#16 RUST FIELDS
	rooms["216"] = new RoomClass(this, "216");
	...
	rooms["216"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["216"].addFlag(GLOBAL.UNVISITED);
	
	//#17 RUST FIELDS
	rooms["217"] = new RoomClass(this, "217");
	...
	rooms["217"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["217"].addFlag(GLOBAL.UNVISITED);
	
	//#18 RUST FIELDS
	rooms["218"] = new RoomClass(this, "218");
	...
	rooms["218"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["218"].addFlag(GLOBAL.UNVISITED);

	//#19 RUST FIELDS
	rooms["219"] = new RoomClass(this, "219");
	...
	rooms["219"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["219"].addFlag(GLOBAL.UNVISITED);

	//#20 RUST CANYON
	rooms["220"] = new RoomClass(this, "220");
	...
	rooms["220"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["220"].addFlag(GLOBAL.UNVISITED);
	
	//#21 RUST CANYON
	rooms["221"] = new RoomClass(this, "221");
	...
	rooms["221"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["221"].addFlag(GLOBAL.UNVISITED);
	
	//#22 NEXT TO\nA JUNK PILE
	rooms["222"] = new RoomClass(this, "222");
	...
	rooms["222"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["222"].addFlag(GLOBAL.UNVISITED);
	
	//#23 NOVA\nPOINT
	rooms["223"] = new RoomClass(this, "223");
	...
	rooms["223"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["223"].addFlag(GLOBAL.UNVISITED);
	
	//#24 SHIPSIDE\nFIELD
	rooms["224"] = new RoomClass(this, "224");
	...
	rooms["224"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["224"].addFlag(GLOBAL.UNVISITED);

	//#25 POLLUTED\nBEACH
	rooms["225"] = new RoomClass(this, "225");
	...
	rooms["225"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["225"].addFlag(GLOBAL.UNVISITED);
	
	//#26 OIL SEA\nBEACH
	rooms["226"] = new RoomClass(this, "226");
	...
	rooms["226"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["226"].addFlag(GLOBAL.UNVISITED);
	
	//#27 OIL SEA\nBEACH
	rooms["227"] = new RoomClass(this, "227");
	...
	rooms["227"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["227"].addFlag(GLOBAL.UNVISITED);

	//#28 OIL SEA\nBEACH
	rooms["228"] = new RoomClass(this, "228");
	...
	rooms["228"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["228"].addFlag(GLOBAL.UNVISITED);

	//#29 OIL SEA\nBEACH
	rooms["229"] = new RoomClass(this, "229");
	...
	rooms["229"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["229"].addFlag(GLOBAL.UNVISITED);
	
	//#30 OIL SEA\nBEACH
	rooms["230"] = new RoomClass(this, "230");
	...
	rooms["230"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["230"].addFlag(GLOBAL.UNVISITED);

	//#31 OIL SEA\nBEACH
	rooms["231"] = new RoomClass(this, "231");
	...
	rooms["231"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["231"].addFlag(GLOBAL.UNVISITED);

	//#32 OIL SEA\nBEACH
	rooms["232"] = new RoomClass(this, "232");
	...
	rooms["232"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["232"].addFlag(GLOBAL.UNVISITED);
	
	//#33 OIL SEA\nBEACH
	rooms["233"] = new RoomClass(this, "233");
	...
	rooms["233"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["233"].addFlag(GLOBAL.UNVISITED);
	
	//#34 OIL SEA\nBEACH
	rooms["234"] = new RoomClass(this, "234");
	...
	rooms["234"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["234"].addFlag(GLOBAL.UNVISITED);
	
	//#35 RUST\nPATH
	rooms["235"] = new RoomClass(this, "235");
	...
	rooms["235"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["235"].addFlag(GLOBAL.UNVISITED);
	
	//#36 RUST\nPATH
	rooms["236"] = new RoomClass(this, "236");
	...
	rooms["236"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["236"].addFlag(GLOBAL.UNVISITED);
	
	//#37 NEXT TO\nA JUNK PILE
	//Busted-ass robots with all useful parts stripped
	rooms["237"] = new RoomClass(this, "237");
	...
	rooms["237"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["237"].addFlag(GLOBAL.UNVISITED);

	//#38 NEXT TO\nA JUNK PILE
	//Busted-ass robots with all useful parts stripped
	rooms["238"] = new RoomClass(this, "238");
	...
	rooms["238"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["238"].addFlag(GLOBAL.UNVISITED);

	//#39 NEXT TO\nA CRASHED SHIP
	rooms["239"] = new RoomClass(this, "239");
	...
	rooms["239"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["239"].addFlag(GLOBAL.UNVISITED);
	
	//#40 NEXT TO\nA CRASHED SHIP
	//SW corner of crashed ship
	rooms["240"] = new RoomClass(this, "240");
	...
	rooms["240"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["240"].addFlag(GLOBAL.UNVISITED);
	
	//#41 NEXT TO\nA JUNK PILE
	//E side of robot pile - fukkin robosexuals
	rooms["241"] = new RoomClass(this, "241");
	...
	rooms["241"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["241"].addFlag(GLOBAL.UNVISITED);
	
	//#42 NEXT TO\nA JUNK PILE
	rooms["242"] = new RoomClass(this, "242");
	...
	rooms["242"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["242"].addFlag(GLOBAL.UNVISITED);
	
	//#43 NEXT TO\nA JUNK PILE
	rooms["243"] = new RoomClass(this, "243");
	...
	rooms["243"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["243"].addFlag(GLOBAL.UNVISITED);
	
	//#44 NEXT TO\nA JUNK PILE
	rooms["244"] = new RoomClass(this, "244");
	...
	rooms["245"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["245"].addFlag(GLOBAL.UNVISITED);
	
	//#46 OIL SEA\nBEACH
	rooms["246"] = new RoomClass(this, "246");
	...
	rooms["246"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["246"].addFlag(GLOBAL.UNVISITED);
	
	//#47 OIL SEA\nBEACH
	rooms["247"] = new RoomClass(this, "247");
	...
	rooms["247"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["247"].addFlag(GLOBAL.UNVISITED);

	//#48 IRON\nRIDGES
	rooms["248"] = new RoomClass(this, "248");
	...
	rooms["248"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["248"].addFlag(GLOBAL.UNVISITED);

	//#49 IRON\nRIDGES
	rooms["249"] = new RoomClass(this, "249");
	...
	rooms["249"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["249"].addFlag(GLOBAL.UNVISITED);

	//#50 IRON\nVALLEY
	rooms["250"] = new RoomClass(this, "250");
	...
	rooms["250"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["250"].addFlag(GLOBAL.UNVISITED);

	//#51 IRON\nRIDGES
	rooms["251"] = new RoomClass(this, "251");
	...
	rooms["251"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["251"].addFlag(GLOBAL.UNVISITED);

	//#52 IRON\nRIDGES
	rooms["252"] = new RoomClass(this, "252");
	...
	rooms["252"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["252"].addFlag(GLOBAL.UNVISITED);

	//#53 RUST\nPLAINS
	rooms["253"] = new RoomClass(this, "253");
	...
	rooms["253"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["253"].addFlag(GLOBAL.UNVISITED);

	//#54 IRON\nRIDGES
	rooms["254"] = new RoomClass(this, "254");
	...
	rooms["254"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["254"].addFlag(GLOBAL.UNVISITED);

	//#55 IRON\nRIDGES
	rooms["255"] = new RoomClass(this, "255");
	...
	rooms["255"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["255"].addFlag(GLOBAL.UNVISITED);

	//#56 IRON\nVALLEY
	rooms["256"] = new RoomClass(this, "256");
	...
	rooms["256"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["256"].addFlag(GLOBAL.UNVISITED);

	//#57 IRON\nRIDGES
	rooms["257"] = new RoomClass(this, "257");
	...
	rooms["257"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["257"].addFlag(GLOBAL.UNVISITED);

	//#58 IRON\nRIDGES
	rooms["258"] = new RoomClass(this, "258");
	...
	rooms["258"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["258"].addFlag(GLOBAL.UNVISITED);

	//#59 RUST\nPLAINS
	rooms["259"] = new RoomClass(this, "259");
	...
	rooms["259"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["259"].addFlag(GLOBAL.UNVISITED);

	//#60 RUST\nPLAINS
	rooms["260"] = new RoomClass(this, "260");
	...
	rooms["260"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["260"].addFlag(GLOBAL.UNVISITED);

	//#61 NEXT TO\nCRASHED SHIP
	rooms["261"] = new RoomClass(this, "261");
	...
	rooms["261"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["261"].addFlag(GLOBAL.UNVISITED);

	//#62 RUST\nFIELDS
	rooms["262"] = new RoomClass(this, "262");
	...
	rooms["262"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["262"].addFlag(GLOBAL.UNVISITED);

	//#63 NEXT TO\nCRASHED SHIPS
	rooms["263"] = new RoomClass(this, "263");
	...
	rooms["263"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["263"].addFlag(GLOBAL.UNVISITED);

	//#64 NEXT TO\nCRASHED SHIPS
	rooms["264"] = new RoomClass(this, "264");
	...
	rooms["264"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["264"].addFlag(GLOBAL.UNVISITED);

	//#65 RUST\nFIELDS
	rooms["265"] = new RoomClass(this, "265");
	...
	rooms["265"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["265"].addFlag(GLOBAL.UNVISITED);

	//#66 RUST\nFIELDS
	rooms["266"] = new RoomClass(this, "266");
	...
	rooms["266"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["266"].addFlag(GLOBAL.UNVISITED);

	//#67 RUST\nFIELDS
	rooms["267"] = new RoomClass(this, "267");
	...
	rooms["267"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["267"].addFlag(GLOBAL.UNVISITED);

	//#68 METAL\nRAVINE
	rooms["268"] = new RoomClass(this, "268");
	...
	rooms["268"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["268"].addFlag(GLOBAL.UNVISITED);

	//#69 SCYTHING\nGLADE
	rooms["269"] = new RoomClass(this, "269");
	...
	rooms["269"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["269"].addFlag(GLOBAL.UNVISITED);

	//#70 SCYTHING\nGLADE
	rooms["270"] = new RoomClass(this, "270");
	...
	rooms["270"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["270"].addFlag(GLOBAL.UNVISITED);

	//#71 SCYTHING\nGLADE
	rooms["271"] = new RoomClass(this, "271");
	...
	rooms["271"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["271"].addFlag(GLOBAL.UNVISITED);

	//#72 SCYTHING\nGLADE
	rooms["272"] = new RoomClass(this, "272");
	...
	rooms["272"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["272"].addFlag(GLOBAL.UNVISITED);

	//#73 SCYTHING\nGLADE
	rooms["273"] = new RoomClass(this, "273");
	...
	rooms["273"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["273"].addFlag(GLOBAL.UNVISITED);

	//#74 SCYTHING\nGLADE
	rooms["274"] = new RoomClass(this, "274");
	...
	rooms["274"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["274"].addFlag(GLOBAL.UNVISITED);

	//#75 SCYTHING\nGLADE
	rooms["275"] = new RoomClass(this, "275");
	...
	rooms["275"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["275"].addFlag(GLOBAL.UNVISITED);

	//#76 SCYTHING\nGLADE
	rooms["276"] = new RoomClass(this, "276");
	...
	rooms["276"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["276"].addFlag(GLOBAL.UNVISITED);

	//#77 PLANET\nDIVIDE
	rooms["277"] = new RoomClass(this, "277");
	...
	rooms["277"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["277"].addFlag(GLOBAL.UNVISITED);

	//#78 SCYTHING\nGLADE
	rooms["278"] = new RoomClass(this, "278");
	...
	rooms["278"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["278"].addFlag(GLOBAL.UNVISITED);

	//#79 ARTIFICIAL\nPLATFORM
	rooms["279"] = new RoomClass(this, "279");
	...
	rooms["279"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["279"].addFlag(GLOBAL.UNVISITED);

	//#81 SCYTHING\nGLADE
	rooms["281"] = new RoomClass(this, "281");
	...
	rooms["281"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["281"].addFlag(GLOBAL.UNVISITED);

	//#82 SCYTHING\nGLADE
	rooms["282"] = new RoomClass(this, "282");
	...
	rooms["282"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["282"].addFlag(GLOBAL.UNVISITED);

	//#83 SCYTHING\nGLADE
	rooms["283"] = new RoomClass(this, "283");
	...
	rooms["283"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["283"].addFlag(GLOBAL.UNVISITED);
	
	//#84 SCYTHING\nGLADE
	rooms["284"] = new RoomClass(this, "284");
	...
	rooms["284"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["284"].addFlag(GLOBAL.UNVISITED);

	//#85 PLANET\nDIVIDE
	rooms["285"] = new RoomClass(this, "285");
	...
	rooms["285"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["285"].addFlag(GLOBAL.UNVISITED);

	//#86 PLANET\nDIVIDE
	rooms["286"] = new RoomClass(this, "286");
	...
	rooms["286"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["286"].addFlag(GLOBAL.UNVISITED);

	//#87 SCYTHING\nGLADE
	rooms["287"] = new RoomClass(this, "287");
	...
	rooms["287"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["287"].addFlag(GLOBAL.UNVISITED);

	//#88 DEAD END\nGLADE
	rooms["288"] = new RoomClass(this, "288");
	...
	rooms["288"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["288"].addFlag(GLOBAL.UNVISITED);

	//#89 SCYTHING\nGLADE
	rooms["289"] = new RoomClass(this, "289");
	...
	rooms["289"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["289"].addFlag(GLOBAL.UNVISITED);

	//#90 SCYTHING\nGLADE
	rooms["290"] = new RoomClass(this, "290");
	...
	rooms["290"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["290"].addFlag(GLOBAL.UNVISITED);

	//#91 SCYTHING\nGLADE
	rooms["291"] = new RoomClass(this, "291");
	...
	rooms["291"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["291"].addFlag(GLOBAL.UNVISITED);

	//#92 NEXT TO\nCRASHED SHIP
	rooms["292"] = new RoomClass(this, "292");
	...
	rooms["292"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["292"].addFlag(GLOBAL.UNVISITED);

	//#93 NEXT TO\nCRASHED SHIP
	rooms["293"] = new RoomClass(this, "293");
	...
	rooms["293"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["293"].addFlag(GLOBAL.UNVISITED);
	
	//#94 Factrory Square
	rooms["294"] = new RoomClass(this, "294");
	...
	rooms["294"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["294"].addFlag(GLOBAL.UNVISITED);

	rooms["295"] = new RoomClass(this, "295");
	...
	rooms["301"] = new RoomClass(this, "301");
	...
	rooms["302"] = new RoomClass(this, "302");
	...
	rooms["303"] = new RoomClass(this, "303");
	...
	rooms["304"] = new RoomClass(this, "304");
	...
	rooms["305"] = new RoomClass(this, "305");
	...
	rooms["350"] = new RoomClass(this, "350");
	...
	rooms["350"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["350"].addFlag(GLOBAL.UNVISITED);

	rooms["351"] = new RoomClass(this, "351");
	...
	rooms["351"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["351"].addFlag(GLOBAL.UNVISITED);

	rooms["352"] = new RoomClass(this, "352");
	...
	rooms["352"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["352"].addFlag(GLOBAL.UNVISITED);

	rooms["353"] = new RoomClass(this, "353");
	...
	rooms["353"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["353"].addFlag(GLOBAL.UNVISITED);
	rooms["353"].addFlag(GLOBAL.COMMERCE);

	rooms["354"] = new RoomClass(this, "354");
	rooms["354"].roomName = "\nWALKWAY";
	...
	rooms["354"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["354"].addFlag(GLOBAL.UNVISITED);
	rooms["354"].addFlag(GLOBAL.COMMERCE);

	rooms["355"] = new RoomClass(this, "355");
	rooms["355"].roomName = "\nWALKWAY";
	...
	rooms["355"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["355"].addFlag(GLOBAL.UNVISITED);

	rooms["356"] = new RoomClass(this, "356");
	...
	rooms["356"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["356"].addFlag(GLOBAL.UNVISITED);

	rooms["357"] = new RoomClass(this, "357");
	...
	rooms["357"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["357"].addFlag(GLOBAL.UNVISITED);

	rooms["358"] = new RoomClass(this, "358");
	...
	rooms["358"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["358"].addFlag(GLOBAL.UNVISITED);
	
	//NE corner of permanent bits
	rooms["359"] = new RoomClass(this, "359");
	...
	rooms["359"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["359"].addFlag(GLOBAL.UNVISITED);

	//West side pirate platform
	rooms["KHORGAN_LEFT_COVER"] = new RoomClass(this, "KHORGAN_LEFT_COVER");
	...
	rooms["KHORGAN_LEFT_COVER"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["KHORGAN_LEFT_COVER"].addFlag(GLOBAL.UNVISITED);

	//Middle Pirate platform
	rooms["KHORGAN_CENTER_COVER"] = new RoomClass(this, "KHORGAN_CENTER_COVER");
	...
	rooms["KHORGAN_CENTER_COVER"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["KHORGAN_CENTER_COVER"].addFlag(GLOBAL.UNVISITED);

	//East pirate platform
	rooms["KHORGAN_RIGHT_COVER"] = new RoomClass(this, "KHORGAN_RIGHT_COVER");
	...
	rooms["KHORGAN_RIGHT_COVER"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["KHORGAN_RIGHT_COVER"].addFlag(GLOBAL.UNVISITED);

	//Ultranorth pirate platform
	rooms["360"] = new RoomClass(this, "360");
	...
	rooms["360"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["360"].addFlag(GLOBAL.UNVISITED);
	rooms["360"].addFlag(GLOBAL.NPC);

	//BOMB ROOM!
	rooms["361"] = new RoomClass(this, "361");
	...
	rooms["361"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["361"].addFlag(GLOBAL.UNVISITED);
	rooms["361"].addFlag(GLOBAL.NPC);

	//SE ROOM!
	rooms["362"] = new RoomClass(this, "362");
	...
	rooms["362"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["362"].addFlag(GLOBAL.UNVISITED);
	
	//S ROOM!
	rooms["363"] = new RoomClass(this, "363");
	...
	rooms["363"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["363"].addFlag(GLOBAL.UNVISITED);
	
	//SW ROOM!
	rooms["364"] = new RoomClass(this, "364");
	...
	rooms["364"].addFlag(GLOBAL.UNDISCOVERED);
	rooms["364"].addFlag(GLOBAL.UNVISITED);

	rooms["WIDGET WAREHOUSE"] = new RoomClass(this, "WIDGET WAREHOUSE");
	...
	//=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
	//=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
	rooms["TEXAS CUSTOMS"] = new RoomClass(this, "TEXAS CUSTOMS");
	...
	//=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
	// THE PHOENIX
	rooms["PHOENIX RECROOM"] = new RoomClass(this, "PHOENIX RECROOM");
	...
	rooms["PHOENIX BRIDGE"] = new RoomClass(this, "PHOENIX BRIDGE");
	...
	rooms["PHOENIX QUARTERS"] = new RoomClass(this, "PHOENIX QUARTERS");
	...
	rooms["PHOENIX CARGO"] = new RoomClass(this, "PHOENIX CARGO");
	...
	rooms["PHOENIX ENGINEERING"] = new RoomClass(this, "PHOENIX ENGINEERING");
	...
	rooms["PHOENIX LIFT L1"] = new RoomClass(this, "PHOENIX LIFT L1");
	...
	rooms["PHOENIX LIFT L2"] = new RoomClass(this, "PHOENIX LIFT L2");
	...
	// KIROS SHIP
	rooms["KIROS SHIP INTERIOR"] = new RoomClass(this, "KIROS SHIP INTERIOR");
	...
	rooms["KIROS SHIP QUARTERS"] = new RoomClass(this, "KIROS SHIP QUARTERS");
	...
	rooms["KIROS SHIP ENGINEERING"] = new RoomClass(this, "KIROS SHIP ENGINEERING");
	...
	rooms["KIROS SHIP TROPHYROOM"] = new RoomClass(this, "KIROS SHIP TROPHYROOM");
	...
	rooms["KIROS SHIP AIRLOCK"] = new RoomClass(this, "KIROS SHIP AIRLOCK");
	...
	//DEBUG
	rooms["DEBUG1"] = new RoomClass(this, "DEBUG1");
